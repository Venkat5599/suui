> ## 🌊 Signal Vault — Sui + Walrus + multi-chain anchoring
> **An autonomous AI trading agent that decides which strategies are worth publishing, then anchors them to decentralized storage with tamper-evident proof on-chain — 24/7.**
>
